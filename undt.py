...
class MinimalPublisher(Node):
    ...
    def timer_callback(self):
        noerror = False
        while noerror == False:
            power = float(input("Enter how much power from 1540 (no power) - 1660 (max power) (1540 is neutral):  "))
            if power != -1:
                turn = float(input("How much do you want to turn from 700 - 2500 (1500 is neutral):  "))
            else:
                turn = 0
